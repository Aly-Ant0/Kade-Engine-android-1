...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if (SONG == null)
			SONG = Song.loadFromJson('lil-goat', 'lil-goat');
		...
		if (SONG.stage == null) {
			switch(storyWeek)
			{
				...
				case 7: if (songLowercase == 'lo-freeze' | 'leader' | 'rooftop-party' | 'mtc') {stageCheck = 'rooftop';}
		...
		switch(stageCheck)
		{
            ...
            back.screenCenter(XY);
						...
						var front:FlxSprite = new FlxSprite(-650, 600).loadGraphic(Paths.image('swagmountain/front'));
						front.updateHitbox();
						front.antialiasing = true;
						front.scrollFactor.set(0.9, 0.9);
						front.active = false;
